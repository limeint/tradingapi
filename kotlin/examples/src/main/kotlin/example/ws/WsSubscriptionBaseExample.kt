...
import example.TRADE_API_SECRET
import kotlinx.coroutines.*
import org.slf4j.Logger
import org.slf4j.LoggerFactory
import com.yourbrand.tradeapi.Action
import com.yourbrand.tradeapi.WebsocketClient
import com.yourbrand.tradeapi.WsRequest
import com.yourbrand.tradeapi.isHandshake
...
abstract class WsSubscriptionBaseExample {
    ...
    fun run(
        ...
        val secret = System.getenv(TRADE_API_SECRET)
        if (secret.isNullOrEmpty()) {
            throw IllegalStateException("$TRADE_API_SECRET env is not set")
        }
